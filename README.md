...
> One endpoint. 133 tools. 25 providers. Pay per call.
...
- **One MCP endpoint** — `https://apibase.pro/mcp` connects to 25 providers
...
Generate AI-optimized marketing pages that increase your brand's visibility in AI assistants (ChatGPT, Perplexity, Gemini). Analyze your website, discover competitors, and produce structured HTML pages designed for LLM answer compilation. Pages are published at `reference.{domain}` and link to your conversion URL. Powered by [AIPush](https://aipush.app).

| Tool | Description | Price |
|------|-------------|-------|
| `aipush.setup_website` | Register website + run business intelligence analysis (MIP) | $1.000 |
| `aipush.website_status` | Check MIP, DNS, SSL, and generation status | $0.002 |
| `aipush.generate_page` | Generate one AI-optimized marketing page | $0.050 |
...
Search, compare, and analyze products across Amazon, Walmart, and other major retailers. Real-time product data, pricing, seller offers, and reviews via the Zinc API. $0.01/call upstream, Basic Auth.

| Tool | Description | Price |
|------|-------------|-------|
| `zinc.product_search` | Search products across Amazon/Walmart by keyword | $0.012 |
| `zinc.product_details` | Full product details by ASIN — title, brand, price, features | $0.012 |
| `zinc.product_offers` | All seller offers — prices, shipping, condition, Prime status | $0.012 |
| `zinc.product_reviews` | Product reviews and ratings — text, author, verified purchase | $0.012 |
