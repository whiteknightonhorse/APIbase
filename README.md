...
> One MCP endpoint. 943 tools. 266 providers. Pay per call with x402 (USDC on Base) or MPP (USDC on Tempo).
...
## Tool Categories (943 tools, 266 providers)
...
GET  /api/v1/tools                      → Live tool catalog (all 943 tools, JSON schemas)
