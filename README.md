...
> One MCP endpoint. 842 tools. 244 providers. Pay per call with x402 (USDC on Base) or MPP (USDC on Tempo).
...
## Tool Categories (842 tools, 244 providers)
...
GET  /api/v1/tools                      → Live tool catalog (all 842 tools, JSON schemas)
