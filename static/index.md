...
> The API Hub for AI Agents — 1388 tools from 397 providers via one MCP endpoint.

## What this is

APIbase aggregates 1388 tools from 397 providers into a single
...
- **Tool catalog:** `GET https://apibase.pro/api/v1/tools` (all 1388 tools with JSON schemas)
