...
> The API Hub for AI Agents — 1384 tools from 396 providers via one MCP endpoint.

## What this is

APIbase aggregates 1384 tools from 396 providers into a single
...
- **Tool catalog:** `GET https://apibase.pro/api/v1/tools` (all 1384 tools with JSON schemas)
