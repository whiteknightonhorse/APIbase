...
> The API Hub for AI Agents — 1373 tools from 394 providers via one MCP endpoint.

## What this is

APIbase aggregates 1373 tools from 394 providers into a single
...
- **Tool catalog:** `GET https://apibase.pro/api/v1/tools` (all 1373 tools with JSON schemas)
